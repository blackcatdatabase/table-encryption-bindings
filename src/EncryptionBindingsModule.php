...
final class EncryptionBindingsModule implements ModuleInterface
{
    public function name(): string { return 'table-encryption_bindings'; }
    public function table(): string { return 'encryption_bindings'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-key_wrappers' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_enc_bind_entity' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_enc_bind_entity' ],
            'foreignKeys' => [ 'fk_enc_bind_kw' ],
        ];
    }
}
