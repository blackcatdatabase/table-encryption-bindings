...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'entity_table', 'entity_pk', 'field_name', 'field_name_norm', 'key_wrapper_id', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\EncryptionBindings\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\EncryptionBindings\Definitions::softDeleteColumn();
