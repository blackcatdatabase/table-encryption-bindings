...
> Schema package for table **encryption_bindings** (repo: `encryption-bindings`).
...
## Relationships
- FK → **key_wrappers** via (key_wrapper_id) (ON DELETE RESTRICT).
...
erDiagram
  ENCRYPTION_BINDINGS {
    ...
    VARCHAR entity_pk
    VARCHAR field_name
    VARCHAR field_name_norm
    INT key_wrapper_id
    TIMESTAMPTZ created_at
  }
  ENCRYPTION_BINDINGS }o--|| KEY_WRAPPERS : "key_wrapper_id"
```
