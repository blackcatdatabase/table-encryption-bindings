...
namespace BlackCat\Database\Packages\EncryptionBindings\Dto;
 ...
 */
final class EncryptionBindingDto implements \JsonSerializable {
    public function __construct(
        public readonly int $id,
        public readonly string $entityTable,
        public readonly string $entityPk,
        public readonly ?string $fieldName,
        public readonly ?string $fieldNameNorm,
