...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 3 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\encryption-bindings](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\encryption-bindings) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package encryption-bindings -Apply
