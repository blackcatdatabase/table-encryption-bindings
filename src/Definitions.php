...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'encryption_bindings'; }
    public static function contractView(): string { return 'vw_encryption_bindings'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'entity_table', 'entity_pk', 'field_name', 'field_name_norm', 'key_wrapper_id', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'entity_table', 'entity_pk', 'field_name_norm' ], [ 'entity_table', 'entity_pk', 'field_name' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'key_wrapper_id' ]; }
    ...
    public static function generatedColumns(): array { return [ 'field_name_norm' ]; }
