...
namespace BlackCat\Database\Packages\EncryptionBindings\Mapper;

use BlackCat\Database\Packages\EncryptionBindings\Dto\EncryptionBindingDto;
use BlackCat\Database\Packages\EncryptionBindings\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO EncryptionBindingDto:
 ...
 */
final class EncryptionBindingDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'entity_table' => 'entityTable', 'entity_pk' => 'entityPk', 'field_name' => 'fieldName', 'field_name_norm' => 'fieldNameNorm', 'key_wrapper_id' => 'keyWrapperId', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'key_wrapper_id' ];
    /** @var string[] */
     ...
     * @return EncryptionBindingDto
     */
    public static function fromRow(array $row): EncryptionBindingDto
    {
        /** @var EncryptionBindingDto */
        return DtoHydrator::fromRow(
            EncryptionBindingDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?EncryptionBindingDto
    {
     ...
     *
     * @param EncryptionBindingDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(EncryptionBindingDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(EncryptionBindingDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(EncryptionBindingDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,EncryptionBindingDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,EncryptionBindingDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(EncryptionBindingDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,EncryptionBindingDto>
     */
