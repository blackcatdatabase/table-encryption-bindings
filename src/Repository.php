...
namespace BlackCat\Database\Packages\EncryptionBindings;
...
use BlackCat\Database\Packages\EncryptionBindings\Repository\EncryptionBindingRepository as GeneratedRepository;
...
{
  private EncryptionBindingRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof EncryptionBindingRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected EncryptionBindingRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionBindings\Dto\EncryptionBindingDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionBindings\Dto\EncryptionBindingDto|null { return $this->repo->getById($id, $asDto); }
