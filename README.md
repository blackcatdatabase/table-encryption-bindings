...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 3 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\encryption-bindings](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\encryption-bindings)
...
graph LR
  ...
  encryption_bindings["encryption_bindings"]:::center
  encryption_bindings -->|FK| key_wrappers["key_wrappers"]:::link
...
- Outbound (depends on): "key_wrappers"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package encryption-bindings -Apply
