...
use BlackCat\Database\Packages\EncryptionBindings\Repository\EncryptionBindingRepository;
...
{
    private EncryptionBindingRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new EncryptionBindingRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionBindings\Dto\EncryptionBindingDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\EncryptionBindings\Dto\EncryptionBindingDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionBindings\Dto\EncryptionBindingDto|null
    {
